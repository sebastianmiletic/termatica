...
@implementation TWindowController { NSString *_cwd; NSView *_root; NSVisualEffectView *_effect; TTabRailView *_tabRail; TTabEdgeView *_tabEdge; NSMutableArray<TTabButton *> *_tabButtons; NSMutableArray<TTerminalView *> *_hyprlandRootOrder; BOOL _animateTabLayout; BOOL _hyprlandApplied,_adjustingScreenFrame; NSRect _preHyprlandFrame,_preHyprlandVisibleFrame,_lastScreenVisibleFrame; TTerminalView *_draggingTerminal; TTerminalView *_dragPositionTarget; NSPoint _dragOffset; TTerminalView *_enteringTerminal; NSTimer *_tabHideTimer; NSTrackingArea *_tabHoverArea; NSRect _tabRailTargetFrame; BOOL _tabRailVisible; BOOL _mouseInTabArea; BOOL _revealRailAfterLayout; }
