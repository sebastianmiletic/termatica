...
- (void)addCommandTVerticalSplit {[self addSplitWithVerticalDivider:YES];}
...
- (void)newTab:(id)sender {TLog(@"vertical split of current tab shortcut");[[self active] addCommandTVerticalSplit];}
