...
static NSString *TCompletionScript(NSString *shell) {
    NSString *commands=@"benchmark bench renderer-report renderer-qualification renderer-campaign qualify renderer-retry retry config config-file update reload editor run completions help version b rr rq rc rt c cf u r e x h v",*configActions=@"list get set create use rename delete",*editors=@"vim nvim emacs nano micro hx";
...
static int TRunCLI(int argc, const char *argv[]) {
    ...
    NSDictionary *quick=@{@"b":@"benchmark",@"c":@"config",@"cf":@"config-file",@"u":@"update",@"r":@"reload",@"rr":@"renderer-report",@"rq":@"renderer-qualification",@"rc":@"renderer-campaign",@"rt":@"renderer-retry",@"e":@"editor",@"x":@"run",@"h":@"help",@"v":@"version"};
    arg=quick[arg]?:arg;
