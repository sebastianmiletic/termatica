...
- (BOOL)isOpaque { return !self.tiledRendering && self.config.backgroundOpacity >= 0.999 && !self.config.blur; }
...
- (NSDictionary *)diagnosticState {
    @synchronized(self){return @{
      ...
      @"metalFrameChecksum":@(_metalBackend.lastFrameChecksum),@"metalFrameVaried":@(_metalBackend.lastFrameVariedPixels),@"snapshotBuildMs":@(_lastSnapshotBuildMilliseconds),
