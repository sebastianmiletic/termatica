...
Fresh `kitten __benchmark__` measurements on an Apple M4 compare the same workloads across Termatica 1.3.0, Kitty 0.48.1, Ghostty 1.3.1, Alacritty 0.17.0, WezTerm 20240203, and Rio 0.5.2. Higher throughput is better; lower startup, memory, and size are better.
