...
The current universal app is **981.5 KiB**, uses **29.4 MiB** of memory at idle, and runs natively on Apple Silicon and Intel Macs. Its measured shell-ready time is **8.817 ms median / 9.305 ms p95**.
...
| App allocation (KiB) | **981.5** | 160,080 | 63,484 | 14,328 | 275,100 | 41,992 |
...
- Universal app allocation: **981.5 KiB** (**1,005,038 bytes**) — under 1 MiB
