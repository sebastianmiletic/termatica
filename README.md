...
The current universal app is **1013.2 KiB**, uses **29.4 MiB** of memory at idle, and runs natively on Apple Silicon and Intel Macs. Its measured shell-ready time is **8.817 ms median / 9.305 ms p95**.
...
| App allocation (KiB) | **1013.2** | 160,080 | 63,484 | 14,328 | 275,100 | 41,992 |
...
- CI-built universal app allocation: **1013.2 KiB** (**1037470 bytes**) — under 1 MiB
