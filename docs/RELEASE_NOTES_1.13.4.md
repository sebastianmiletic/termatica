...
Termatica 1.13.4 completes ordinary non-Hyprland pane behavior and hardens the
motion, hiding, and default-profile paths around it.

- Horizontal, vertical, and mixed splits now work without enabling Hyprland.
...
- Motion respects the macOS Reduce Motion setting.
